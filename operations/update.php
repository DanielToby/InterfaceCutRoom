...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $input_cutter_speed = trim($_POST["cutter speed"]);
    if(empty($cutter_speed)){
        $cutter_speed_err = "Please enter the cutter speed.";     
    ...
    if(empty($name_err) && empty($brand_err) && empty($cutter_speed_err)){
        ...
        $sql = "UPDATE jobs SET name=?, brand=?, cutter_speed=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_brand, $param_cutter_speed, $param_id);
